...
public class SendMoney extends AppCompatActivity
{
    ...
    com.priya.basicbank.Adapters.SendMoney adapter;
    ...
    private void showData(String phonenumber)
    {
        ...
        adapter = new com.priya.basicbank.Adapters.SendMoney(SendMoney.this, modelList_sendtouser);
    ...
    public void selectuser(int position)
    {
        ...
        while(cursor.moveToNext())
        {
            ...
            calculateAmount();
            startActivity(new Intent(SendMoney.this, SuccessSplashScreen.class));
    ...
    public void onBackPressed()
    {
        ...
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", (dialogInterface, i) -> {
                    new Database(SendMoney.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
