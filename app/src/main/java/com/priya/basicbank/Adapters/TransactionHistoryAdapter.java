...
import com.priya.basicbank.Activities.TransactionHistoryActivity;
...
public class HistoryAdapter extends RecyclerView.Adapter<ViewHolderAdapter> {
    ...
    public ViewHolderAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_transferlayout, parent, false);
